...
module Examples.AG.PP.HaskellPP.LRC.PrettyP
  ( -- * Pretty printing
    Pretty,
...
import Examples.AG.PP.LRC.LRC_Pretty as P
...
renderStyleMode d = disp d 1000 "" -- 3rd disp parameter is starting string - compare Core module, lines 75 (best) and 78 (dispf) 
